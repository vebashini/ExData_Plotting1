...
plot(elec_pow_cons_df$DateTime, elec_pow_cons_df$Sub_metering_1,type='l', ylab ="Energy sub metering", xlab="")
lines(elec_pow_cons_df$DateTime, elec_pow_cons_df$Sub_metering_2, col='red')
lines(elec_pow_cons_df$DateTime, elec_pow_cons_df$Sub_metering_3, col="blue")
